			...
			if(isset($_GET['id'])){
				...
				if(!isset($_POST['edit'])){
					echo "<font size='1.5'>
							...
							<textarea name=\"content\" style=\"height:120px;width:80%;\">".stripslashes($n['content'])."</textarea><br/><br/>
					...
					if($title == ""){
						...
						$u = mysql_query("UPDATE `web_news` SET `title`='".$title."',`type`='".$cat."',`content`='".$content."' WHERE `id`='".$id."'") or die(mysql_error());
